...
//	calcNum
//	정수형 2개의 ‘매개변수’를 넘겨 받아, 
//	더한 값을 출력해주는 기능을 가진 메소드 구현

//	calcNum 
//	정수형 1개, 실수형 1개의 ‘매개변수’를 넘겨 받아 더한 결과값을
//	리턴(return)해 주는 기능을 가진 메소드 구현

//	calcNum
//	실수형 1개를 ‘매개변수’로 넘겨 받아 
//	정수형으로 바꿔주는 기능을 가진 메소드 메소드 구현
...
//	필드에 저장된 색을 출력하는 메소드 이름을 출력 메소드를 구현하세요.
//	ex) "홍길동"
